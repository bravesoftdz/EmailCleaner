...
constructor TFileDialog.Create(Component: TComponent);
var
...
function TFileDialog.getFilePath: string;
begin
  Result := FilePath;
end;

procedure TFileDialog.Load;
var
  OpenDialog: TOpenDialog;
begin
...
procedure TFileDialog.save(const Content: string);
var
